    ...
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
        ...
        {[...Array(5)].map((_, idx) => (
          <div
            key={idx}
            className="size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-discord-brand-color cursor-not-allowed hover:text-white text-gray-400"
          >
        ...
        <div className="size-12 mt-auto bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 cursor-not-allowed hover:bg-[#3ba55c] text-[#3ba55c] hover:text-white">
          <PlusCircle />
        </div>
      </div>
      ...
      <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
        <div className="px-4 h-16 border-b border-[#202225] shadow-sm flex items-center">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          ...
          <div className="px-2 mb-4">
            ...
            <div className="flex items-center px-2 py-1.5 bg-[#393c43] rounded text-white cursor-pointer">
              <Image
      ...
      <div className="flex-1 flex flex-col">
        {/* dm header */}
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#20222b]">
